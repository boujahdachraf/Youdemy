    ...
    <nav class="bg-pink-600 text-white px-6 py-4">
        <div class="flex justify-between items-center">
            ...
            <div class="flex items-center gap-4">
                <a href="pages/login.php" class="bg-pink-700 px-4 py-2 rounded hover:bg-pink-800">Login</a>
                <a href="pages/register.php" class="bg-green-600 px-4 py-2 rounded hover:bg-green-700">Register</a>
            </div>
        </div>
    </nav>
        ...
        <div class="mb-8">
            <form action="" method="GET" class="flex gap-4">
                <input type="text" name="search" value="<?php echo htmlspecialchars($search); ?>" 
                       placeholder="Search by course name, teacher, category, or tags..." 
