...
$teacher = new Teacher($db, ['user_id' => $_SESSION['user_id']]);
                ...
                <div class="bg-white rounded-lg shadow-lg overflow-hidden">
                    ...
                    <div class="p-6">
                        ...
                        <div class="flex flex-wrap gap-2 mb-4">
                            <span class="px-2 py-1 bg-pink-100 text-pink-800 rounded text-sm">
                        ...
                        <div class="flex justify-between items-center">
                            <div class="space-x-2">
                                <a href="teacher_edit.php?id=<?php echo $course['course_id']; ?>" 
                                   class="inline-block px-3 py-1 bg-pink-500 text-white rounded hover:bg-pink-600">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <form method="POST" action="teacherdash.php" class="inline-block" onsubmit="return confirm('Are you sure you want to delete this course?');">
                            ...
                            <a href="teacher_enrollments.php?id=<?php echo $course['course_id']; ?>" 
    ...
    <div id="addCourseModal" class="hidden fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full">
        <div class="relative top-20 mx-auto p-5 border w-2/3 shadow-lg rounded-md bg-white">
            <div class="mt-3">
                ...
                <form action="teacherdash.php" method="POST" enctype="multipart/form-data">
