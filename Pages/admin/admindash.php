...
<body class="bg-gray-100">
    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            ...
            <div class="bg-white p-6 rounded-lg shadow">
                <h3 class="text-gray-500 mb-2">Active Teachers</h3>
                <p class="text-2xl font-bold"><?php echo $stats['users']['teacher_count']; ?></p>
            </div>
            <div class="bg-white p-6 rounded-lg shadow">
                    ...
                    <div class="p-6">
                        ...
                        <div class="flex gap-2 mt-4">
                            <a href="admin_review.php?id=<?php echo $course['course_id']; ?>" 
                               class="flex-1 bg-pink-500 text-white text-center py-2 rounded hover:bg-pink-600">
