    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex justify-between items-center mb-6">
                ...
                <button onclick="openAddModal()" class="bg-pink-500 text-white px-4 py-2 rounded hover:bg-pink-600">
            ...
            <div class="bg-white rounded-lg shadow-lg p-6 w-full max-w-md">
                ...
                <form method="POST">
                    ...
                    <div class="flex justify-end gap-2">
                        ...
                        <button type="submit"
                                class="bg-pink-500 text-white px-4 py-2 rounded hover:bg-pink-600">Add Tag</button>
                    </div>
                </form>
            </div>
        </div>
                ...
                <form method="POST">
                    ...
                    <div class="flex justify-end gap-2">
                        <button type="button" onclick="closeModal('editModal')"
                                class="bg-gray-500 text-white px-4 py-2 rounded hover:bg-gray-600">Cancel</button>
                        <button type="submit"
                                class="bg-pink-500 text-white px-4 py-2 rounded hover:bg-pink-600">Update Tag</button>
                    </div>
                </form>
            </div>
        </div>
