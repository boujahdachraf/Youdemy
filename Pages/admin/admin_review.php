...
// Get course details
$query = "SELECT c.*, u.username as teacher_name, u.email as teacher_email,
...
<body class="bg-gray-100">
    <nav class="bg-pink-600 text-white px-6 py-4">
        <div class="flex justify-between items-center">
            ...
            <a href="admindash.php" class="bg-pink-700 px-4 py-2 rounded hover:bg-pink-800">
        ...
        <div class="grid grid-cols-3 gap-8">
            ...
            <div class="col-span-1">
                <div class="bg-white rounded-lg shadow-lg p-6">
                    ...
                    <div class="space-y-4">
                        <div>
                            <h3 class="text-sm text-gray-500">Teacher</h3>
                            <p class="font-medium"><?php echo htmlspecialchars($course['teacher_name']); ?></p>
                            <p class="text-sm text-gray-600"><?php echo htmlspecialchars($course['teacher_email']); ?></p>
                        </div>
